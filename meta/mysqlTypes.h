...
constexpr uint8_t mysqlTypeMaps[] = { T_DECIMAL,T_INT8,T_INT16,T_INT32,T_FLOAT,T_DOUBLE,T_MAX_TYPE,T_TIMESTAMP,T_INT64,T_INT32,T_DATE,T_TIME,T_DATETIME,T_YEAR,T_DATE,T_STRING,T_BLOB,T_TIMESTAMP,T_DATETIME,T_TIME,
