...
{
	static constexpr auto SECTION = "replicator";
	static constexpr auto SRC_TYPE = "srcType";
	static constexpr auto DEST_TYPE = "destType";
	static constexpr auto THREAD_COUNT = "threadCount";
	static constexpr auto REP_STRATEGY = "strategy";
