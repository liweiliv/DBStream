...
#pragma pack(1)
	...
	public:
		solidBlock(blockManager* blockManager, META::metaDataBaseCollection* metaDataCollection,uint32_t flag) :block(blockManager, metaDataCollection,flag), m_fd(INVALID_HANDLE_VALUE), m_tableInfo(nullptr), m_recordInfos(nullptr),
