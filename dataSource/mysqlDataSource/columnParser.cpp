...
*/
	...
	{
		if (newOrOld)
			record->setVarColumn(colMeta->m_columnIndex, data, colMeta->m_size);
		else
			record->setVardUpdatedColumn(colMeta->m_columnIndex, data, colMeta->m_size);
		data += colMeta->m_size;
		return 0;
	}
